...
object Constants {
    //Intervalo de comprobacion de localizacion cada 4 segundos
    const val INTERVAL_LOCATION = 4

    //Limite aceptado BIKE -> 40 metros por segundo
    ...
    //Limite aceptado ROLLERSKATE -> 126km/h
    ...
    ////Limite aceptado RUNNING -> 43.2km/h
